...
from parti.config import ver2cfg
from parti.stage2 import CondTransformer
from parti.encoder import CLIPTextEmbedder as TextEmbedder
from parti.config import *
import cv2
...
config = Config(config=ver2cfg['paintmindv1'])
parti = Pipeline(config=config, stage1_pretrained=True)
parti.from_pretrained('/home/pranoy/code/parti/your/result/folder/models/paintmind_step_215000.pt')
parti.eval()

text = ['a painting of a cat']
imgs = parti.generate(text)
print(len(imgs))