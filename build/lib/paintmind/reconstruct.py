...
if __name__ == '__main__':
    img_path = '/home/pranoy/Downloads/photo-1623184663110-89ba5b565eb6.jpeg'
    img = reconstruction(img_path=img_path, model_name='vit-s-vqgan', titles=['origin', 'reconstruct'], checkpoint_path=None, scale=0.8)
